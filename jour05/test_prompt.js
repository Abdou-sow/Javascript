...
prompt.get(["username", "email","age"], function (err, res) {  // demande à obtenir les propriétés "username" et "email"
//   if (err) {
// 		return onErr(err);
// 	}
  ...
  console.log("=> age : " + res.age);//affiche le résultat pour la propriété "l'age"
});